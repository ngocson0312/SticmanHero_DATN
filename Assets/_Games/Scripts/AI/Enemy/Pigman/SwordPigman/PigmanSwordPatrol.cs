...
{
    public class PigmanSwordPatrol : State
    {
        PigManSword enemy;

        public PigmanSwordPatrol(PigManSword controller, string stateName) : base(controller, stateName)
        {
        ...
        public override void UpdateLogic()
        {
            ...
            if (target != null)
            {
                enemy.SwitchState(enemy.pigmanSwordChaseSate);
                return;
            }
        }
