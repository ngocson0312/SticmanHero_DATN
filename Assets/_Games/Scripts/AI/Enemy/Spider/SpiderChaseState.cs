...
{
    public class SpiderChaseState : State
    {
        private Spider enemy;
        private int currentDirection;
        public SpiderChaseState(Spider controller, string stateName) : base(controller, stateName)
        {
        ...
        public override void UpdatePhysic()
        {
            ...
            else
            {
                ...
                if (Vector2.SqrMagnitude(target.transform.position - enemy.transform.position) <= enemy.attackRange)
                {
                    ...
                    enemy.SwitchState(enemy.spiderAttackState);
                }
            }
        }
    }
